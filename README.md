...
### Improved Waypoints
Supports [Wurst7-CevAPI](https://github.com/cev-api/Wurst7-CevAPI) waypoints, Xaero Waypoints and its own waypoint system via right click context menu. Can also remove SeedMapper waypoints with right click.
