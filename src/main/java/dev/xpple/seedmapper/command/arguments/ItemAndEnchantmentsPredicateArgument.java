...
public class ItemAndEnchantmentsPredicateArgument implements ArgumentType<ItemAndEnchantmentsPredicateArgument.EnchantedItem> {
    ...
    private static final Map<String, Integer> ITEMS = ImmutableMap.<String, Integer>builder()
        ...
        .put("coast_armor_trim_smithing_template", Cubiomes.ITEM_COAST_ARMOR_TRIM_SMITHING_TEMPLATE())
        .put("compass", Cubiomes.ITEM_COMPASS())
        ...
        .put("feather", Cubiomes.ITEM_FEATHER())
        ...
        .put("iron_chain", Cubiomes.ITEM_IRON_CHAIN())
        ...
        .put("lapis_lazuli", Cubiomes.ITEM_LAPIS_LAZULI())
        .put("leather", Cubiomes.ITEM_LEATHER())
        .put("leather_boots", Cubiomes.ITEM_LEATHER_BOOTS())
        .put("leather_chestplate", Cubiomes.ITEM_LEATHER_CHESTPLATE())
        .put("leather_helmet", Cubiomes.ITEM_LEATHER_HELMET())
        .put("leather_leggings", Cubiomes.ITEM_LEATHER_LEGGINGS())
        ...
        .put("map", Cubiomes.ITEM_MAP())
        .put("moss_block", Cubiomes.ITEM_MOSS_BLOCK())
        ...
        .put("suspicious_stew", Cubiomes.ITEM_SUSPICIOUS_STEW())
    ...
    public static final Map<Integer, Item> ITEM_ID_TO_MC = ImmutableMap.<Integer, Item>builder()
        ...
        .put(Cubiomes.ITEM_CHAIN(), Items.IRON_CHAIN)
        .put(Cubiomes.ITEM_CLOCK(), Items.CLOCK)
        .put(Cubiomes.ITEM_COAL(), Items.COAL)
        .put(Cubiomes.ITEM_COAST_ARMOR_TRIM_SMITHING_TEMPLATE(), Items.COAST_ARMOR_TRIM_SMITHING_TEMPLATE)
        .put(Cubiomes.ITEM_COMPASS(), Items.COMPASS)
        ...
        .put(Cubiomes.ITEM_FEATHER(), Items.FEATHER)
        ...
        .put(Cubiomes.ITEM_LAPIS_LAZULI(), Items.LAPIS_LAZULI)
        .put(Cubiomes.ITEM_LEATHER(), Items.LEATHER)
        .put(Cubiomes.ITEM_LEATHER_BOOTS(), Items.LEATHER_BOOTS)
        .put(Cubiomes.ITEM_LEATHER_CHESTPLATE(), Items.LEATHER_CHESTPLATE)
        .put(Cubiomes.ITEM_LEATHER_HELMET(), Items.LEATHER_HELMET)
        .put(Cubiomes.ITEM_LEATHER_LEGGINGS(), Items.LEATHER_LEGGINGS)
        ...
        .put(Cubiomes.ITEM_MAP(), Items.MAP)
        .put(Cubiomes.ITEM_MOSS_BLOCK(), Items.MOSS_BLOCK)
        ...
        .put(Cubiomes.ITEM_PAPER(), Items.PAPER)
        .put(Cubiomes.ITEM_PIGLIN_BANNER_PATTERN(), Items.PIGLIN_BANNER_PATTERN)
        .put(Cubiomes.ITEM_POISONOUS_POTATO(), Items.POISONOUS_POTATO)
        ...
        .put(Cubiomes.ITEM_PUMPKIN(), Items.PUMPKIN)
        ...
        .put(Cubiomes.ITEM_SUSPICIOUS_STEW(), Items.SUSPICIOUS_STEW)
